...
public class GroupInviteJoinTest {
	private static final String TAG = "GroupInviteJoinTest";
	...
	@Test
	public void testGroupInviteJoin() {
		try {
			commonSyncher.reset();
	...
	@Test
	public void testGroupInviteStranger() {
		try {
			commonSyncher.reset();
			friendConnSyncher.reset();
			groupSyncher.reset();
	...
	@Test
	public void testGroupInviteMySelf() {
		try {
			commonSyncher.reset();
			friendConnSyncher.reset();
			groupSyncher.reset();
			...
			try {
				group.invite(carrier.getUserId());
			}
			catch (GeneralException e) {
				final int ELAERR_NOT_EXIST = 0x0A;
				assertEquals(CarrierException.FACILITY_GENERAL, e.getFacility());
	...
	@Test
	public void testGroupInviteTwice() {
		try {
			commonSyncher.reset();
			friendConnSyncher.reset();
			groupSyncher.reset();
	...
	@Test
	public void testGroupJoinTwice() {
		try {
			commonSyncher.reset();
			friendConnSyncher.reset();
			groupSyncher.reset();
	...
	@Test
	public void testGroupLeaveThenJoin() {
		try {
			commonSyncher.reset();
			friendConnSyncher.reset();
			groupSyncher.reset();
